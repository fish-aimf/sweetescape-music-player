# SweetEscape — A Full-Featured Music Player

> "Built with love and passion with JavaScript."

SweetEscape is an original, **Spotify replacement** — a static, full-featured music player made entirely with **HTML, CSS, and JavaScript**.
...
* **AI** enabled playlist generation.
* Tracks **billboard hot-100** charts
* Is designed for **speed, simplicity, and beauty** — with a goal of hitting **1 million visits**. (3800 visits as of 10/16/2025) (7764 visits as of 11/20/2025)
...
* Queue, temporaily skip, autoplay, volume control, speed controls, visualizer
...
| Hosting            | Vercel (previously Glitch.me )          |
...
* Drag around the elements and move them around. 
...
Special thanks to Youtube, Google developers studio, Google AI studio, Vercel, Glitch, Gemini, Openai Chatgpt, Claude, Supabase, Youtube API, Spotify, Discord, Google analytics, Twitter, Picsvg, mhollingshead/billboard-hot-100/, supadata API, AADS, Crawlers, apify, browserstack selenium 
