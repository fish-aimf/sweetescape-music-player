...
- allows website to run the discord directly by adding specified path and testing if sweetescape:// protocol is registered. so the app can be run from the website. v46.6.0
