...
-  glass mode: the active tab was a solid opaque accent block against otherwise translucent chrome; tabs now blur what is behind them, the active tab is a tinted accent glass, and the tab row and content pane share one rounded edge v72.1.0
-  glass mode: the now playing tab kept its own surface tint on top of the tab panel, stacking two translucent layers into a nearly solid slab, so it looked unchanged; it now shares the panel material while the thumbnail and transport buttons become lighter glass chips, and the music explorer panel is considerably more transparent v72.2.0
